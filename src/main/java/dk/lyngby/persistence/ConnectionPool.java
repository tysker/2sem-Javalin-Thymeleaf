...
public class ConnectionPool {
    ...
    public synchronized Connection getConnection() throws SQLException {
        LOGGER.info(Marker.ANY_MARKER, "Getting connection");
    ...
    public synchronized void close() {
        LOGGER.info(Marker.ANY_MARKER, "Shutting down connection pool");
        ds.close();
    }
    ...
    private static HikariDataSource createHikariConnectionPool(String user, String password, String url, String db) {
        LOGGER.info(Marker.ANY_MARKER, "Connection Pool created for: ({}, {}, {}, {})", user, password, url, db);
